...
const resend = new Resend('re_3HrDKzti_AeijYnUrDqziFEUb9McU1o4i');
...
export async function sendContactEmail(formData: ContactFormData): Promise<ContactFormResult> {
  try {
    ...
    // Use fixed recipient email for contact form submissions
    const recipientEmail = 'murayamagenji394@gmail.com';

    // Send email using Resend
    const resend = new Resend('re_125')
