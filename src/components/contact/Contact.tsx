    ...
    <section id="contact" className="py-20 bg-gradient-to-b from-background/80 to-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-stretch lg:gap-16">
          ...
          <div className="glass-card flex w-full min-h-0 flex-1 flex-col rounded-xl p-8">
            <ContactForm />
          </div>

          {/* Contact Information — matches Send Message panel height & width on large screens */}
